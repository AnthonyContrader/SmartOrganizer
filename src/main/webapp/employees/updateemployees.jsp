...
<meta name="description" content="Employees Edit page">
...
<form id="floatleft" action="/employees/update" method="post">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input
			type="text" id="surname" name="surname" value=<%=e.getSurname()%>> 
    </div>
  </div>
  <div class="row">
    <div class="col-25">
