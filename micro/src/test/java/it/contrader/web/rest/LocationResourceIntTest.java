...
import it.contrader.domain.Location;
import it.contrader.repository.LocationRepository;
import it.contrader.service.LocationService;
import it.contrader.service.dto.LocationDTO;
import it.contrader.service.mapper.LocationMapper;
...
public class LocationResourceIntTest {
    ...
    private static final String DEFAULT_TYPEOFLOCATION = "AAAAAAAAAA";
    private static final String UPDATED_TYPEOFLOCATION = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            ...
            .city(DEFAULT_CITY)
            .typeoflocation(DEFAULT_TYPEOFLOCATION)
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getTypeoflocation()).isEqualTo(DEFAULT_TYPEOFLOCATION);
        assertThat(testLocation.getWorktype()).isEqualTo(DEFAULT_WORKTYPE);
    }
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].typeoflocation").value(hasItem(DEFAULT_TYPEOFLOCATION.toString())))
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.typeoflocation").value(DEFAULT_TYPEOFLOCATION.toString()))
    ...
    public void updateLocation() throws Exception {
        ...
        updatedLocation
            ...
            .city(UPDATED_CITY)
            .typeoflocation(UPDATED_TYPEOFLOCATION)
        ...
        assertThat(testLocation.getTypeoflocation()).isEqualTo(UPDATED_TYPEOFLOCATION);
        assertThat(testLocation.getWorktype()).isEqualTo(UPDATED_WORKTYPE);
    }
