...
import { WorkgroupComponent } from 'app/entities/SmartOrganizerMicro/workgroup/workgroup.component';
...
describe('Component Tests', () => {
    describe('Workgroup Management Component', () => {
        let comp: WorkgroupComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WorkgroupComponent, '')
                .compileComponents();
